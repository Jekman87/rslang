    ...
    <div class="container mt-3">
      <div class="jumbotron pt-4">
        ...
        <div class="statistics bg-white p-2 rounded">
          <h5 class="statistic-title"><i class="fas fa-user-chart"></i> Статистика</h5>
          <div class="row">
                ...
                <div class="card-body">
                  ...
                  <ul class="list-group">
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Слов на сегодня
                      <span class="badge badge-info badge-pill">15 из 30</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                      Карточек на сегодня
                      <span class="badge badge-info badge-pill">30 из 50</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="card bg-light">
                <div class="card-body">
                  ...
                  <ul class="list-group">
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                      Всего выучено слов
                      <span class="badge badge-info badge-pill">550 из 3600</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                       Всего карточек пройдено
                      <span class="badge badge-info badge-pill">1256</span>
                    </li>
                  </ul>
                </div>
              </div>
