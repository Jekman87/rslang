      ...
      <div class="riddle-main-container">
        <header class="riddle-header">
          ...
          <div class="difficulty-level">
            <span>Уровень</span>
            <div>
              <button type="button" class="btn btn-outline-success riddle-button" data-click="minus-level">-</button>
                <input type="number" min="1" max="6" value="1" readonly class="input-level">
              <button type="button" class="btn btn-outline-success riddle-button" data-click="plus-level">+</button>
            </div>
          </div>
          ...
          <div class="difficulty-page">
            <span>Раунд</span>
            <div>
              <button type="button" class="btn btn-outline-success riddle-button" data-click="minus-page">-</button>
                <input type="number" min="1" max="15" value="1" readonly class="input-page">
              <button type="button" class="btn btn-outline-success riddle-button" data-click="plus-page">+</button>
            </div>
          </div>

          <button type="button" class="btn btn-outline-success riddle-button" data-click="start-game">Запустить игру</button>
        ...
        <div class="riddle-prompts">
          <div>
            <button type="button" class="btn btn-outline-success riddle-button" data-click="show-options">
              <i class="fas fa-eye" data-click="show-options"></i>
            </button>
            <button type="button" class="btn btn-outline-success riddle-button" data-click="remove-wrong">50/50</button>
            <button type="button" class="btn btn-outline-success riddle-button" data-click="show-translate">
        ...
        <div class="riddle-container">
          ...
          <form class="riddle-answer-form">
            <input class="riddle-answer-input" type="text" placeholder="Введите ваш вариант ответа здесь..." name="search-area"
              autocomplete="off">
            <button type="button" class="btn btn-outline-success riddle-button" data-click="check">Проверить ответ</button>
            <button type="button" class="btn btn-outline-success riddle-button" data-click="pass">Не знаю</button>
          </form>
    ...
    <div class="riddle-statistic-screen">
      <div class="riddle-statistic-blocks">
        ...
        <div class='riddle-statistic-buttons'>
          <button class="btn btn-success riddle-statistic-button" data-click="return">Вернуться к игре</button>
          <button class="btn btn-success riddle-statistic-button" data-click="correct-answers">Отгадано</button>
          <button class="btn btn-success riddle-statistic-button" data-click="wrong-answers">Не отгадано</button>
      ...
      <div class="riddle-statistic-blocks-correct">
        ...
        <div class='riddle-statistic-buttons'>
          <button class="btn btn-success riddle-statistic-button" data-click="return-statistic">Вернуться к статистике</button>
        </div>
      </div>
