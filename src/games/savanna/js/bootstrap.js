...
(function (global, factory) {
  ...
  const Carousel = /* #__PURE__ */(function () {
    ...
    _proto.to = function to(index) {
      ...
      if (this._isSliding) {
        $(this._element).one(EVENT_SLID, () => _this.to(index));
        return;
      }
    ...
    _proto._addEventListeners = function _addEventListeners() {
      ...
      if (this._config.keyboard) {
        $(this._element).on(EVENT_KEYDOWN, (event) => _this2._keydown(event));
      }

      if (this._config.pause === 'hover') {
        $(this._element).on(EVENT_MOUSEENTER, (event) => _this2.pause(event)).on(EVENT_MOUSELEAVE, (event) => _this2.cycle(event));
      }
  ...
  $(document).on(EVENT_KEYDOWN_DATA_API, SELECTOR_DATA_TOGGLE$2, Dropdown._dataApiKeydownHandler).on(EVENT_KEYDOWN_DATA_API, SELECTOR_MENU, Dropdown._dataApiKeydownHandler).on(`${EVENT_CLICK_DATA_API$4} ${EVENT_KEYUP_DATA_API}`, Dropdown._clearMenus)
  ...
  const Modal = /* #__PURE__ */(function () {
    ...
    _proto.show = function show(relatedTarget) {
      ...
      $(this._element).on(EVENT_CLICK_DISMISS, SELECTOR_DATA_DISMISS, (event) => _this.hide(event));
      $(this._dialog).on(EVENT_MOUSEDOWN_DISMISS, () => {
        $(_this._element).one(EVENT_MOUSEUP_DISMISS, (event) => {
    ...
    _proto._setResizeEvent = function _setResizeEvent() {
      ...
      if (this._isShown) {
        $(window).on(EVENT_RESIZE, (event) => _this7.handleUpdate(event));
      } else {
  ...
  $(document).on(EVENT_CLICK_DATA_API$5, SELECTOR_DATA_TOGGLE$3, function (event) {
    ...
    var $target = $(target).one(EVENT_SHOW$2, (showEvent) => {
      if (showEvent.isDefaultPrevented()) {
  ...
  const Tooltip = /* #__PURE__ */(function () {
    ...
    _proto._setListeners = function _setListeners() {
      ...
      triggers.forEach((trigger) => {
        if (trigger === 'click') {
          $(_this5.element).on(_this5.constructor.Event.CLICK, _this5.config.selector, (event) => _this5.toggle(event));
          ...
          $(_this5.element).on(eventIn, _this5.config.selector, (event) => _this5._enter(event)).on(eventOut, _this5.config.selector, (event) => _this5._leave(event));
        }
      });
  ...
  const ScrollSpy = /* #__PURE__ */(function () {
    function ScrollSpy(element, config) {
      ...
      $(this._scrollElement).on(EVENT_SCROLL, (event) => _this._process(event));
      this.refresh();
  ...
  const Toast = /* #__PURE__ */(function () {
    ...
    _proto._setListeners = function _setListeners() {
      ...
      $(this._element).on(EVENT_CLICK_DISMISS$1, SELECTOR_DATA_DISMISS$1, () => _this2.hide());
    };
